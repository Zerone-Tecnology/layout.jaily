...
<div class="wrapper">
        ...
        <div class="container">
            <div class="articles">
                ...
                <div class="video_play_btn">
                    <div class="circle">
                        <a href="https://www.youtube.com/channel/UCqv-coahV12UMJiFX7g1mzg" target="_blank"><img loading="lazy" src="/wp-content/themes/jailydesign/img/play.png" alt=""></a>
    ...
    <section class="section_3 lazyload_for_div" id="s3">
        ...
        <div class="portfolio">
            <div class="portfolio_img">
                ...
                <!-- <div class="mix category_a portfolio_carousel">
						<div class="owl-carousel owl-theme">
							<div class="item"><img loading="lazy" src="/wp-content/themes/jailydesign/img/portfolio/portfolio_1.png" alt=""></div>
							<div class="item"><img loading="lazy" src="/wp-content/themes/jailydesign/img/portfolio/portfolio_1.png" alt=""></div>
							<div class="item"><img loading="lazy" src="/wp-content/themes/jailydesign/img/portfolio/portfolio_1.png" alt=""></div>
						</div>
						<div class="portfolio_carousel_articles">
					...
					<div class="mix category_a portfolio_carousel">
						<div class="owl-carousel owl-theme">
							<div class="item"><img loading="lazy" src="/wp-content/themes/jailydesign/img/portfolio/portfolio_2.png" alt=""></div>
							<div class="item"><img loading="lazy" src="/wp-content/themes/jailydesign/img/portfolio/portfolio_2.png" alt=""></div>
							<div class="item"><img loading="lazy" src="/wp-content/themes/jailydesign/img/portfolio/portfolio_2.png" alt=""></div>
						</div>
						<div class="portfolio_carousel_articles">
					...
					<div class="mix category_a portfolio_carousel">
						<div class="owl-carousel owl-theme">
							<div class="item"><img loading="lazy" src="/wp-content/themes/jailydesign/img/portfolio/portfolio_3.png" alt=""></div>
							<div class="item"><img loading="lazy" src="/wp-content/themes/jailydesign/img/portfolio/portfolio_3.png" alt=""></div>
							<div class="item"><img loading="lazy" src="/wp-content/themes/jailydesign/img/portfolio/portfolio_3.png" alt=""></div>
						</div>
						<div class="portfolio_carousel_articles">
        ...
        <div class="container">
            ...
            <div class="order_card_wrapper">
                <div class="order_card">
                    ...
                    <p class="price_articles">Создадим дизайн проект, по которому будут выполняться все
                        ремонтно-отделочные работы.</p>
                ...
                <div class="order_card">
                    <h5>Пакет <br>“Авторский надзор” </h5>
                    <p class="price_articles">Проектируем ключевые моменты в ремонте, чтобы все было выполнено по
                        дизайн-проекту</p>
                    <ul class="order_card_list">
                        <li>Планировочное решение</li>
                        <li>Дизайн-концепция</li>
                        ...
                        <li>Подбор материалов</li>
                        <li>Строительные чертежи</li>
                        <li><b>Авторский надзор 2 раза в неделю (до 6 месяцев)</b></li>
                    </ul>
                    <h6 class="price">От <span>От 12 500 ₸</span> за м²</h6>
                    <p class="description">*Постоянным клиентам - скидка 10%</p>
                    <button class="default_btn red" id="open_modal_btn">Заказать дизайн</button>
                </div>
                <div class="order_card">
                    <h5>Пакет <br>“Premium” </h5>
                    <p class="price_articles">Управление стройкой, организация поставки мебели и материалов со
                        стороны агентства, финальное декорирование</p>
                    <ul class="order_card_list">
                        <li>Планировочное решение</li>
                        <li>Дизайн-концепция</li>
                        <li>3D визуализация</li>
                        ...
                        <li><b>Управление стройкой </b></li>
                        <li><b>Организация поставки мебели и материалов</b></li>
                        <li><b>Финальное декорирование</b></li>
                    </ul>
                    <h6 class="price">От <span>От 21 500 ₸</span> за м²</h6>
                    <p class="description">*Постоянным клиентам - скидка 10%</p>
                    <button class="default_btn red" id="open_modal_btn">Заказать дизайн</button>
                </div>
            </div>
        ...
        <div class="container">
            ...
            <div class="stages_of_work">
                ...
                <div class="stages">
                    <div class="stages_left">
                        <h4>02</h4>
                        <h5>Разработка <br>дизайн-проекта</h5>
                    </div>
                    <div class="stages_right">
                ...
                <div class="stages">
                    ...
                    <div class="stages_right">
                        <p>Обсуждаем все оставшиеся вопросы, вносим необходимые корректировки и согласовываем
                            результат
                            работы</p>
                    </div>
                </div>
    ...
    <section class="team_section" id="s6">
        ...
        <img loading="lazy" src="/wp-content/themes/jailydesign/img/team_img.png" class="team_img" alt="">
        <div class="container">
...
<div class="item">
						<div class="review_card">
							<div class="user">
								<div class="user_img">
									<img loading="lazy" src="/wp-content/themes/jailydesign/img/user_1.png" alt="">
								</div>
								<div class="user_name">
									<h6>Гульшара</h6>
									<p>Жилой дом мкр-н "Юбилейный"</p>
					...
					<div class="item">
						<div class="review_card">
							<div class="user">
								...
								<div class="user_img">
									<img loading="lazy" src="/wp-content/themes/jailydesign/img/user_2.png" alt="">
								</div>
								<div class="user_name">
									<h6>Жанар</h6>
